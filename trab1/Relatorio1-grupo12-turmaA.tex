...
% \def\lastedit{2010-03-16 17:57:54 by stolfi}
      ...
      \savebox{\TR@Banner}{
        \hbox{
          \begin{minipage}[c]{\TR@BannerSX mm}
            ...
            {\TR@LARGE\TR@sf{UNIVERSIDADE DE S{\~A}O PAULO}\par}
            \vskip 5pt
            {\TR@Huge\TR@sf{ICMC}\par}
          \end{minipage}
        }
      }
      ...
      \savebox{\TR@NumDate}{
        \vbox to\TR@NumDateSY mm{
          ...
          {\centering
            ...
            \vfill
            \TR@normal
            \TR@sf{Technical Report\quad-\quad  {\TR@year}-{\TR@number}\quad-\quad Relat{\'o}rio T{\'e}cnico}
            \par
            \kern 5pt
      ...
      \savebox{\TR@Cover}{
        ...
        \begin{picture}(\TR@CoverSX,\TR@CoverSY)
          ...
          % Left sky blue outline:
          {
            ...
            \put(28.88,59.0){\line(1,0){10.24}}
            \put(29.0,58.88){\line(0,1){27.24}}
            \put(28.88,86.0){\line(1,0){10.24}}
            \put(39.0,85.88){\line(0,1){58.24}}
            \put(33.88,144.0){\line(1,0){5.24}}
            \put(34.0,143.88){\line(0,1){62.24}}
            \put(33.88,206.0){\line(1,0){5.24}}
          ...
          
          {
            ...
            \put(40.88,59.0){\line(1,0){120.24}}
            \put(161.0,58.88){\line(0,1){27.24}}
            \put(40.88,86.0){\line(1,0){120.24}}
            \put(41.0,85.88){\line(0,1){58.24}}
            \put(40.88,144.0){\line(1,0){115.24}}
            \put(156.0,143.88){\line(0,1){62.24}}
            \put(40.88,206.0){\line(1,0){115.24}}
            \put(41.0,205.88){\line(0,1){48.24}}
          }
          
          \put(\TR@UnicampLogoDX,\TR@UnicampLogoDY){
            \makebox(0,0)[bl]{\hbox{\includegraphics[scale=0.27]{logo_usp.jpg}}}
          }
          
          \put(\TR@ICLogoDX,\TR@ICLogoDY){
            \makebox(0,0)[bl]{\hbox{\includegraphics[scale=0.5]{logo_icmc_usp.png}}}
          }
          ...
          \put(\TR@BannerDX,\TR@BannerDY){
            \makebox(\TR@BannerSX,\TR@BannerSY){
              \begin{minipage}[c]{\TR@BannerSX mm}
                ...
                \hsize \TR@BannerSX mm
                \hrule height 0pt
                {\centering\TR@LARGE\TR@Huge\TR@sf{UNIVERSIDADE DE S{\~A}O PAULO}\par}
                \vskip 5.0mm
                {\centering\TR@sf{INSTITUTO DE CI{\^E}NCIAS MATEM{\'A}TICAS E DE COMPUTA{\c C}{\~A}O}\par}
                \vskip 0.0mm
                \hrule height 0pt
              \end{minipage}
            }
...
% Restore \endlinechar:
\advance\endlinechar by +256\makeatothe